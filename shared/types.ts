...
export type Config = { config_version: string, theme: ThemeMode, executor_profile: ExecutorProfileId, disclaimer_acknowledged: boolean, onboarding_acknowledged: boolean, notifications: NotificationConfig, editor: EditorConfig, workspace_dir: string | null, last_app_version: string | null, show_release_notes: boolean, show_new_attempt_drag_warning: boolean, language: UiLanguage, git_branch_prefix: string, showcases: ShowcaseState, };
